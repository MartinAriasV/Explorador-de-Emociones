...
export const SHOP_ITEMS: ShopItem[] = [
    ...
    { id: 'frame-gold', name: 'Marco Dorado', description: 'Un marco dorado brillante para tu avatar.', cost: 250, type: 'avatar_frame', value: 'bg-gradient-to-br from-amber-400 to-yellow-500', icon: '🖼️' },
    { id: 'frame-silver', name: 'Marco Plateado', description: 'Un marco plateado elegante para tu avatar.', cost: 150, type: 'avatar_frame', value: 'bg-gradient-to-br from-slate-400 to-gray-500', icon: '🖼️' },
