...
export const SHOP_ITEMS: ShopItem[] = [
    ...
    { id: 'frame-gold', name: 'Marco Dorado', description: 'Un marco dorado brillante para tu avatar.', cost: 250, type: 'avatar_frame', value: 'border-8 border-amber-400', icon: '🖼️' },
    { id: 'frame-silver', name: 'Marco Plateado', description: 'Un marco plateado elegante para tu avatar.', cost: 150, type: 'avatar_frame', value: 'border-8 border-slate-400', icon: '🖼️' },
